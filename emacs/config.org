...
#+BEGIN_SRC emacs-lisp
  ...
  (setq send-mail-function 'sendmail-send-it
        ...
        notmuch-saved-searches '((:name "📥 [ayosemail@gmail] Inbox"
  				      :query "tag:gmail and tag:inbox"
  				      :key "g")

  			       (:name "📥 [mail@ayoonipe] Inbox"
  				      :query "tag:zoho and tag:inbox"
  				      :key "z")

  			       (:name "📤 [ayosemail@gmail] Sent"
  				      :query "tag:gmail and tag:sent"
  				      :key "s")

  			       (:name "📤 [mail@ayoonipe] Sent"
  				      :query "tag:zoho and tag:sent"
  				      :key "S")

  			       (:name "📦 All [ayosemail@gmail]"
  				      :query "tag:gmail"
  				      :key "G")

  			       (:name "📦 All [mail@ayoonipe]"
  				      :query "tag:zoho"
  				      :key "Z")))
