...
Any manual installations in this config will be prepended with MANUAL.
...
** TODO Search: Figure out rg on guix
#+BEGIN_SRC emacs-lisp
...
** Autosaves
Visit init.el to see how this connects with no-littering
...
** Common
*** TODO Sticky Header: Have to use package-install
#+BEGIN_SRC emacs-lisp
...
** TODO Database Management: Figure out db management
#+BEGIN_SRC emacs-lisp
...
** Agenda
[[https://blog.aaronbieber.com/2016/09/24/an-agenda-for-life-with-org-mode.html][Guide on Org Agenda]]
